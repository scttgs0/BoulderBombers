...
GameStamps      ;.byte $00,$00,$00,$00,$00,$00,$00,$00      [00]
                ...
                .dword %00000000111111111111111111111111         ; ........########################
                .dword %11111111000011110000000011111111         ; ########....####........########
                .dword %11111111111111111111111111110000         ; ############################....
                .dword %11110000000000000000000000000000         ; ####............................

                ;.byte $00,$00,$01,$83,$BF,$D3,$7E,$00      [0A]   plane left-B
                .dword %00000000000000000000000000000000         ; ................................
                .dword %00000000000000000000000000000000         ; ................................
                .dword %00000000000000000000000000001111         ; ............................####
                .dword %11110000000000000000000011111111         ; ####....................########
                .dword %11110000111111111111111111111111         ; ####....########################
                .dword %11111111000011110000000011111111         ; ########....####........########
                .dword %00001111111111111111111111110000         ; ....########################....
                .dword %00000000000000000000000000000000         ; ................................
                ...
                .dword %00000000000000000000000000000000         ; ................................
                .dword %11110000000000000000000000000000         ; ####............................
                .dword %11111111000000000000000000000000         ; ########........................
                .dword %11111111111111111111111100000000         ; ########################........
                .dword %11111111000000001111000011111111         ; ########........####....########
                .dword %00001111111111111111111111111111         ; ....############################
                .dword %00000000000000000000000000001111         ; ............................####
                ...
                .dword %00000000000000000000000000000000         ; ................................
                .dword %11110000000000000000000000000000         ; ####............................
                .dword %11111111000000000000000000001111         ; ########....................####
                .dword %11111111111111111111111100001111         ; ########################....####
                .dword %11111111000000001111000011111111         ; ########........####....########
                .dword %00001111111111111111111111110000         ; ....########################....
                .dword %00000000000000000000000000000000         ; ................................

                ;.byte $3C,$7E,$FF,$00,$FF,$FF,$7E,$3C      [16]   balloon
                .dword %00000000111111111111111100000000         ; ........################........
                .dword %00001111111111111111111111110000         ; ....########################....
                ...
                .dword %00000000000011111111000000000000         ; ............########............
                .dword %00000000111100000000111100000000         ; ........####........####........
                .dword %00000000111100000000111100000000         ; ........####........####........
                .dword %00000000000011111111000000000000         ; ............########............
                .dword %00000000000011111111000000000000         ; ............########............
                .dword %00000000000000000000000000000000         ; ................................
